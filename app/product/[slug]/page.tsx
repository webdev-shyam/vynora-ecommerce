              ...
              <Card className="p-4 bg-blue-50 border-blue-100">
                <div className="grid grid-cols-3 gap-4 text-center">
                  <div>
                    ...
                    <div className="text-[11px] text-gray-500">256-bit SSL</div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="text-xs font-medium">60-Day Refund</div>
                    <div className="text-[11px] text-gray-500">Risk Free</div>
                  </div>
                </div>
              </Card>
            </div>
                ...
                <div className="flex items-end justify-between mb-5">
                  <div>
                    ...
                    <div className="text-xs text-gray-500 mt-1">
                      Digital product • Instant lifetime download
                    </div>
                  </div>
                  <Badge className="bg-emerald-600 hover:bg-emerald-700 gap-1 px-3 py-1 text-xs">
